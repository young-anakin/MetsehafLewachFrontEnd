...
export default function Home() {
  ...
  return (
    ...
    <div className=' font-vidaloka  text-white bg-black  min-h-screen'>
          <div className="mx-auto w-[900px] container ">
            
          <Header/>

            <div className="flex flex-col text-center font-vidaloka text-5xl items-center pt-80 text-[#F5F5DC]">
              <h1>Trade books you’ve read.</h1>
              <h1>Discover new reads to explore.</h1>
            ...
            <div className="text-center py-20">
              <button className="button" data-text="Awesome">
                  <span className="actual-text">&nbsp;ENTRY&nbsp;</span>
                  ...
                  >
                    {/* SIGN UP */}
                    <span aria-hidden="true" className="hover-text">&nbsp;ENTRY&nbsp;</span>
